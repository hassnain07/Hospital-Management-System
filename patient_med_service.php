    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        ?>
            ...
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>Patients Services & Medicines</h1>
              </div>
              <div class="col-sm-6">
          ...
          <div class="container-fluid">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">
                  Services & Medicines To Patients are given here
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               <form action="patient_med_service_mgm.php" method="post">
                <div class="row">
                  <div class="col-md-6">
                ...
                $sel_qry = $conn->query("SELECT * FROM patients WHERE status =
                        1"); while($row = $sel_qry->fetch(PDO::FETCH_ASSOC)){ ?>
                        <option value="<?php echo $row['admission_id']?>">
                          <?php echo $row['patient_name']."(".$row['admission_id'].")"?>
                        </option>
                        <?php
                }
                ?>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select
                        class="select2bs4"
                        multiple="multiple"
                        data-placeholder="Select Services here"
                        style="width: 100%"
                        name="services[]"
                      >
                        <?php
                $sel_qry = $conn->query("SELECT * FROM services WHERE status =
                        1"); while($row = $sel_qry->fetch(PDO::FETCH_ASSOC)){ ?>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select
                        class="select2bs4"
                        multiple="multiple"
                        data-placeholder="Select Medicines here"
                        style="width: 100%"
                        name="medicines[]"
                      >
                        <?php
                $sel_qry = $conn->query("SELECT * FROM medicines WHERE status =
                        1"); while($row = $sel_qry->fetch(PDO::FETCH_ASSOC)){ ?>
