...
<div class="row">
  ...
  <!-- /.login-logo -->
  <div class="card"><br>
  <center><img src="docs\assets\img\logo1.png" width="70%" height="150px" alt="" align="center"></center>

    <div class="card-body login-card-body">
    <div class="login-logo">
    
    <a href="dashboard.php"><b>Ghani Hospital</b></a>
  </div>
      ...
      <div class="social-auth-links text-center mb-3">
        ...
        <button class="btn btn-block btn-primary" name="admin_login">
           Sign In
        </button>
      </div>
