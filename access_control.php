      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="card card-default">
            ...
            <form action="access_control_mgm.php" method="post">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <select name="role" id="roless" class="form-control"  required>
              ...
              <div class="row">
                <div class="col-md-4 offset-4">
                  <input type="submit" name="add_admin" class="btn btn-primary btn-block" value="Add User">
                </div>
              </div>
