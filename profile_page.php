            ...
            <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Admin Name" name="user_name" value="<?php echo $user_data['admin_name']?>" required>
                  </div>  
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="" name="designation" value="<?php 
                    $role_name = $conn->query("SELECT * FROM roles WHERE role_id = '".$user_data['role']."'")->fetch(PDO::FETCH_ASSOC);
