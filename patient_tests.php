          ...
          <div class="container-fluid">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">
                  Lab tests To Patients are given here
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               <form action="patients_tests_mgm.php" method="post">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select
                        class="select2bs4"
                        multiple="multiple"
                        data-placeholder="Select Tests here"
                        style="width: 100%"
                        name="tests[]"
                      >
                        <?php
                $sel_qry = $conn->query("SELECT * FROM lab_tests WHERE status =
                        1"); while($row = $sel_qry->fetch(PDO::FETCH_ASSOC)){ ?>
